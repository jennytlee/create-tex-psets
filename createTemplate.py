...
def main():
    ...
    while not finished:
        ...
        filename = className + "Assignment" + assignmentNumber + ".tex"
...
\\newpage
        ...
        \\end{document}""")
            ...
            if createHMCpset != 'n' and createHMCpset != 'N':
...
\ExecuteOptions{header,palatino,unboxed}
...
\newcommand{\problemlist}[1]{\begin{center}\large\rmfamily{#1}\end{center}}
...
\newcommand{\teacher}[1]{\def\hmcpset@teacher{#1}}
